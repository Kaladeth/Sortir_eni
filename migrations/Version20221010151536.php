 ...
 */
final class Version20221010151536 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sortie ADD lieu_id INT NOT NULL, ADD etat_sortie_id INT NOT NULL, ADD site_id INT NOT NULL, ADD organisateur_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_3C3FD3F23CE09FBF ON sortie');
        $this->addSql('DROP INDEX IDX_3C3FD3F2F6BD1646 ON sortie');
        $this->addSql('DROP INDEX IDX_3C3FD3F2D936B2FA ON sortie');
        $this->addSql('ALTER TABLE sortie DROP lieu_id, DROP etat_sortie_id, DROP site_id, DROP organisateur_id');
    }
}
